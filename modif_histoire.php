...
<body>
  ...
  <div class="container">
    <!-- Accordéon permanent d'ajout de paragraphe -->
    <div class="accordion" id="accordionExample">
      <div class="card">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
          <div class="card-body">
            <!-- Descrition courte du paragraphe -->
            <form class="form-horizontal" role="form" enctype="multipart/form-data" action="traiteajoutparaph.php?id_histoire=<?= $id_histoire ?>" method="post">
              ...
              <!-- Est-ce le dernier paragraphe pour gagner ? -->
              <div class="form-group">
              ...
              <!-- Indication du paragraphe parent -->
              ...
              <select id="paradepart" name="paradepart">
                ...
                //Cas où c'est le premier paragraphe crée et que par conséquent on ne le relit à rien 
                if ($nb == 0) {
                ?>
                  <option value="">Aucun paragraphe pour l'instant. Je crée le premier !</option>
                  <?php
                } else {
                  //Liste des paragraphes existants 
      ...
      <?php
      //Requête qui renvoie les lignes de toutes les pages de l'histoire choisie
      $maRequete = "SELECT * FROM pages WHERE id_histoire = $id_histoire";
      $response = $BDD->query($maRequete);
      $nb = $response->rowCount();
      $tab = $response->fetchAll();
      ...
      ?>
        <!-- Accordéons pour chaque paragraphe existant permettant de les modifier -->
        <!-- Même modèle que le précédant  -->
        <!-- Champs pré remplis avec les informations actuelles du paragraphe -->
        <div class="card">
              ...
              <form class="form-horizontal" role="form" enctype="multipart/form-data" action="traitemodifparaph.php?id_histoire=<?= $id_histoire ?>&id_page=<?= $id ?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <label for="choix"></label>
                    <?php
                    //Pre-checked ou non selon les informations de la BDD
                    if ($is_deadend == 0) {
                ...
                <select id="paradepart" name="paradepart">
                  ...
                  ?>
                    ...
                    foreach ($tab as $key => $ligne) {
                      ...
                      //Pour ne pas afficher deux fois un paragraphe dans la liste
                ...
                <!-- Bouton de confirmation de mise à jour -->
                <div class="form-group">
                  <div class="col-sm-4 col-sm-offset-4 mt-2">
